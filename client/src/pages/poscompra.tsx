...
export default function PosCompra() {
  ...
  return (
    <div className="min-h-screen bg-[#070607] text-white overflow-hidden selection:bg-[#D8B366] selection:text-black font-sans relative flex items-center justify-center">
      ...
      {/* CONTENT */}
      <motion.div 
        className="relative z-10 container mx-auto max-w-2xl px-6 py-20 md:py-0 text-center"
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="mb-6 md:mb-8">
          ...
          <p className="text-2xl md:text-3xl text-[#D8B366] font-serif italic">
            🎉
          </p>
        </motion.div>
        ...
        <motion.div variants={fadeInUp} className="space-y-4 mb-10 md:mb-14">
          <div className="bg-[#D8B366]/10 border border-[#D8B366]/30 rounded-lg p-4 md:p-6 backdrop-blur-sm">
            <div className="flex items-start gap-3 md:gap-4">
              <Lock className="w-5 h-5 md:w-6 md:h-6 text-[#D8B366] flex-shrink-0 mt-1" />
              <div className="text-left">
                <p className="text-white font-semibold mb-2">🔒 Fique tranquilo(a):</p>
                <ul className="text-sm md:text-base text-white/80 space-y-1 font-light">
        ...
        <motion.div variants={fadeInUp} className="space-y-4">
          <a 
            ...
            className="relative flex items-center justify-center gap-2 bg-[#D8B366] text-black text-base md:text-lg font-bold px-8 md:px-10 h-12 md:h-14 rounded-lg transition-all duration-300 group overflow-hidden hover:shadow-[0_0_30px_rgba(216,179,102,0.5)] hover:scale-105 active:scale-95 w-full md:w-auto inline-flex mx-auto"
        ...
        {/* FOOTER MESSAGE */}
        <motion.div variants={fadeInUp} className="mt-12 md:mt-16 pt-8 md:pt-12 border-t border-white/10">
          <p className="text-sm md:text-base text-white/60 font-light">
            Obrigado por sua inscrição! Esperamos vê-lo(a) no evento.
          </p>
          <p className="text-[#D8B366] font-display font-bold text-sm md:text-base tracking-widest uppercase mt-4">
            Sessão Processo & IA
          </p>
        </motion.div>
      </motion.div>
